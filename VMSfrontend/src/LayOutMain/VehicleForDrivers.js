...
class ListVehicleForDriversComponent extends Component{
...
//change delete with glyficon or google icon
   ...
   render() {
        return (
            <div>
                 <h2 className="text-center">Available Vehicle List</h2>
                                        ...
                                        <tr key = {vehicle.vehicleId}>
                                            ...
                                            <td> {vehicle.chessisNumber}</td>
                                             ...
                                             <td>
                                                 ...
                                                 //send or generate email/message/notification after picking the vehicle from driver side
                                                 <Link class="btn btn-outline-primary mr-2" to={`/vehicle/edit/${vehicle.id}`} >  pick Vehicle </Link>
                                                 <Link className="btn btn-primary" to={`/user/${vehicle.id}`}>View Details</Link>
                                             </td>
                                        </tr>
                                    )
                                }
...
export default ListVehicleForDriversComponent;